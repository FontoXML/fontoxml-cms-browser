...
import DocumentGridItem from '../documents/DocumentGridItem.jsx';
import DocumentListItem from '../documents/DocumentListItem.jsx';
import DocumentPreview from '../documents/DocumentModalPreview.jsx';
...
class TemplateBrowserModal extends Component {
	static propTypes = {
...
TemplateBrowserModal = withModularBrowserCapabilities(TemplateBrowserModal, viewModes[0] /* list*/);
